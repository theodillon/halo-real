...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    <head>
        ...
        <meta name="description" content="Halo Burger has 16 locations throughout Michigan. We use 100% fresh, never-frozen, premium beef & the freshest ingredients, made to order. Call us today.">
    ...
    <body class="unsticky-body">
        ...
        <div id="weather" class="but-toggled">
          ...
          <ul class="weather-nav">
              <li>
                <a href="http://www.haloburger.com/rewards" class="h5">
                <i class="fa fa-mobile"></i>&emsp;Rewards App
                <span class="sr-only"> Like us on Facebook</span>
              </a>
              </li>
              <li>
                <a href="http://www.haloburger.com/careers" class="h5">
        ...
        <header class="site-header unsticky" role="navigation">
            <div class="container-fl">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" title="Halo Burger Home" href="#">
                ...
                <nav id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="http://www.haloburger.com/menu.php"><span>Menu</span></a></li>
                        <li><a href="http://www.haloburger.com/locations.php"><span>Locations</span></a></li>
                        <li><a href="http://www.haloburger.com/comments"><span>Comments</span></a></li>
                        <li><a class="only-toggled" href="http://www.haloburger.com/careers">Careers</a></li>
                        <li><a class="only-toggled" href="http://www.haloburger.com/rewards">Rewards App</a></li>
                    </ul>
                    <form class="navbar-form navbar-right" role="search">
                      <div class="form-group">
                        <label for="find-halo"><i class="fa fa-lg fa-map-marker"></i></label>
                        <input type="text" id="find-halo" class="form-control" placeholder="Enter City or ZIP">
                      </div>
        ...
        <div class="jumbo">
          <div class="content">
            <h3 class="h3">3 Generations</h3>
            <h1 class="h1">From our family to yours</h1><br>
            <a class="btn btn-lg btn-default" href="family.php">Read more</a> 
          </div>
        </div>
        <section class="stripe">
          <p><i class="fa fa-2x fa-newspaper-o"></i>Look out for Toni, Michael and Helena in your mailbox along with some valuable coupons in this month's RedPlum!</p>
        </section>
        <section class="fresh">
          <h3 class="h3">100% fresh, never frozen burgers</h3>
        </section>
        ...
        <div class="container-fl">
            <div class="row">
            	<div class="col-sm-6 left-main">
                    <h1>Earn points.<br>Get rewards.</h1>
                    <h2>Download the official <br>Halo Burger loyalty app</h2>
                    <ul class="downloads">
                    	<li id="appstore">
                        	<a class="appstore hide-text" title="Download on the App Store" href="https://itunes.apple.com/us/app/halo-burger/id909668020?mt=8&uo=4" target="itunes_store">iPhone
                            </a>
                        </li>  
                    	<li id="playstore">
                            <a class="playstore hide-text" title="Get it on Google Play" href="https://play.google.com/store/apps/details?id=com.ak.app.haloburger.activity" target="play_store">Android
                            </a>
                        </li>
                    </ul>                  
                </div>
                ...
                <div class="col-sm-6 right-main">
                    <img src="http://www.haloburger.com/img/qp-works-cheese.png" width="300" height="300" alt=""/>
                    <div class="carousel-caption">
                        <h3>Free QP<br><span>after your first points!</span></h3>
                    </div>
        		</div><!--/ right column -->
            </div><!--/.row -->
        </div><!--/.container -->
        ...
        <div class="container-fluid marketing-container">
            <div class="row marketing">
                <div class="col-xs-12">
                	<h2>How it works</h2>
                    <p>Once you register your account, <span class="breaker"></span>it's as easy as 1, 2, 3.</p>
                </div>
                <div class="col-sm-4">
                    <div class="img-circle order hide-text">Order
                    </div>
                    <h4>1. Order</h4>
                    <p>Enjoy a delicious meal at Halo Burger. Be sure to get a receipt for your purchase.</p><p class="small">$1 = 10 points, so the more you buy, the more you earn.</p>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-4">
                    <div class="img-circle scan hide-text">Scan
                    </div>
                    <h4>2. Snap</h4>
                    <p>Take a picture of <em>(snap)</em> your receipt in the app and hit Submit.</p><p class="small">Points are automatically added to your account when they are accepted.</p>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-4">
                    <div class="img-circle redeem hide-text">Redeem
                    </div>
                    <h4>3. Redeem</h4>
                    <p>When you collect enough points, redeem them for free food at Halo Burger!</p><p class="small">Earn more points by sharing us or referring your friends to the app.</p>
                </div><!-- /.col-lg-4 -->
                <div class="col-xs-12">
                	<h5>Plus...</h5>
                    <p>The Halo Burger app has addresses, phone numbers, and directions to the nearest or any location, and it can connect you directly to our social feeds.</p>
                	<p><span class="fa fa-wifi"></span> All Halo Burger locations have <strong>FREE WI-FI.</strong></p>
                </div>
      		</div><!-- /.row -->
        </div><!--/.container -->
        <a class="back-to-top" href="#"><span class="fa fa-caret-up"></span>&emsp;&emsp;Back to top</a>
        <div class="container footer">
        	<footer>
          	<ul class="social">
              	<li><a href="http://www.facebook.com/haloburgerfans" title="Like us on Facebook"><span class="fa fa-facebook-square"></span><span class="sr-only">Facebook</span></a></li>
                  <li><a href="http://www.twitter.com/halo_burger" title="Follow us on Twitter"><span class="fa fa-twitter"></span><span class="sr-only">Twitter</span></a></li>
                  <li><a href="http://www.instagram.com/halo_burger" title="Follow us on Instagram"><span class="fa fa-instagram"></span><span class="sr-only">Instagram</span></a></li>
              </ul>
          	<h4><a title="Halo Burger App Terms of Use" href="http://www.relevantmobile.com/halo-burger-terms-of-use.html">Terms of Use</a></h4>
              <h4><a title="Halo Burger App Privacy Policy" href="http://www.relevantmobile.com/halo-burger-privacy-policy.html">Privacy Policy</a></h4>
          	<p class="small copyright">© Halo Burger 2014</p>
          </footer>
 		</div>       
    ...
    ================================================== -->
        ...
        <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
		    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-51a61d811216776c" async="async"></script>
